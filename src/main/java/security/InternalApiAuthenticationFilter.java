...
{
    private final  String accesessKey;

    public InternalApiAuthenticationFilter(String accesessKey) {
        this.accesessKey = accesessKey;
    }
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            if (requestkey == null || requestkey.equals(accesessKey))
            {
